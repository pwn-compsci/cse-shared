...
no_period_menu_confirmation = context['menu_confirmation'].replace('.', '')
context['menu_confirmation_replaced'] = escape_for_regex(no_period_menu_confirmation).replace('__', "[0-9]+")
...
context['encrypted_flag_length'] = len(flag)
